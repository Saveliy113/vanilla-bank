...
export class CardService {
	...
	/**
	 * Updates user's balance with te specified amount and type.
	 *
	 * @param {number} amount - Amount to be added or withdrawn
	 ...
	 *
	 * @function
	 * @param {Object} body - Transfer details.
	 * @param {number} body.amount - The amount to be transferred.
	 * @param {string} body.toCardNumber - The recipient's card number.
	 * @param {Function} onSuccess - Callback function to be
	 * executed upon successful transfer.
